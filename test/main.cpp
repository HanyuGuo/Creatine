...
int main(int argc, char *argv[]) {
  if (argc == 2) {
    ...
    printf("Usage:mpirun -np <numberOfProcessors> ./hanyug-assignment3 <read_image_path> <write_image_path> <image_size> <kernel_type> <filter_type>\n");
    printf("kernel_type: MPI or CUDA_MPI\n");
    printf("filter_type: 1, 2\n");
    printf("e.g mpirun -np 4 ./hanyug-assignment3 ./Lenna_Images/Lenna_org_256.pgm ./Lenna_Images/Lenna_org_write.pgm 256 CUDA_MPI 1\n");
    return 0;
  }
}